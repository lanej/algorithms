...
func TestReadBoard(t *testing.T) {
	...
	expectedBoard := [][]byte{
		[]byte{clean, bot, clean, clean, clean, clean, dirty},
		[]byte{clean, dirty, clean, clean, clean, dirty, clean},
		[]byte{dirty, clean, clean, dirty, dirty, clean, clean},
		[]byte{clean, clean, clean, dirty, clean, clean, clean},
		[]byte{clean, clean, clean, clean, clean, clean, dirty},
	}
